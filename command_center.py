...
class CommandCenterDialog(wx.Dialog):
    def __init__(self, parent, project_dir):
        ...
        self.scroll_vbox.Add(sizer_local, flag=wx.EXPAND | wx.LEFT | wx.RIGHT | BOTTOM, border=10)
    ...
    def on_set_jlc_constraints(self, event):
        try:
            ...
            dlg = wx.MessageDialog(self, msg, "Apply JLCPCB Constraints", wx.YES_NO | wx.ICON_QUESTION)
